...
* **Access to data** - Assessors are only able to answer the questions generated by the data assessment app if they can see the data. Your data representative should be able to access their date easily - they do own it after all.
